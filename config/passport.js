...
var TwitterStrategy = require('passport-twitter').Strategy; /* added in class */
var User = require('../models/user');
var configAuth = require('./auth'); /* added in class */
...
/*
 * cadged from https://github.com/minneapolis-edu/simple-auth-fav-color-twitter-auth/blob/master/config/passport.js
 */
